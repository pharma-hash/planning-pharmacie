// ── ÉQUIPE ────────────────────────────────────────────────────────────────
const TEAM=[
  {id:1,slug:'bennoui',  name:'BENNOUI Imran',  sh:'IB',role:'alt',label:'Préparateur Alternant',       color:'#92400e',bg:'#fef3c7'},
  {id:2,slug:'afriyie',  name:'AFRIYIE Grace',  sh:'GA',role:'ph', label:'Pharmacienne (fin études)',    color:'#1e40af',bg:'#dbeafe'},
  {id:3,slug:'addaoud',  name:'ADDAOUD Imene',  sh:'IA',role:'pr', label:'Préparatrice',                 color:'#065f46',bg:'#d1fae5'},
  {id:4,slug:'badet',    name:'BADET Aurelie',  sh:'AB',role:'alt',label:'Préparatrice en formation',    color:'#92400e',bg:'#fef3c7'},
  {id:5,slug:'tounekti', name:'TOUNEKTI Ines',  sh:'IT',role:'alt',label:'Préparatrice en alternance',   color:'#92400e',bg:'#fef3c7'},
  {id:6,slug:'benayed',  name:'BEN AYED Rayen', sh:'RB',role:'alt',label:'Alternant polyvalent',         color:'#92400e',bg:'#fef3c7'},
  {id:7,slug:'goldbronn',name:'GOLDBRONN Clara',sh:'CG',role:'ph', label:'Pharmacienne',                 color:'#1e40af',bg:'#dbeafe'},
  {id:8,slug:'kabour',   name:'KABOUR Sirine',  sh:'SK',role:'pr', label:'Préparatrice',                 color:'#065f46',bg:'#d1fae5'},
  {id:9,slug:'medjdoub', name:'MEDJDOUB Ahlam', sh:'AM',role:'alt',label:'Alternante',                   color:'#92400e',bg:'#fef3c7'},
];
...
const SCHED={
  1:[{empId:1,s:'08:30',e:'19:30'},{empId:3,s:'08:30',e:'19:30'},{empId:6,s:'10:00',e:'19:30'},{empId:9,s:'09:00',e:'17:00'}],
  2:[{empId:1,s:'08:30',e:'19:30'},{empId:3,s:'08:30',e:'19:30'},{empId:6,s:'10:00',e:'19:30'},{empId:9,s:'09:00',e:'17:00'}],
  3:[{empId:3,s:'08:30',e:'19:30'},{empId:6,s:'10:00',e:'19:30'},{empId:7,s:'08:30',e:'19:30'},{empId:8,s:'08:30',e:'19:30'}],
  4:[{empId:5,s:'08:30',e:'19:30'},{empId:6,s:'10:00',e:'19:30'},{empId:7,s:'08:30',e:'19:30'},{empId:8,s:'08:30',e:'19:30'},{empId:9,s:'09:00',e:'17:00'}],
  5:[{empId:5,s:'08:30',e:'19:30'},{empId:6,s:'10:00',e:'19:30'},{empId:7,s:'08:30',e:'19:30'},{empId:8,s:'08:30',e:'19:30'},{empId:9,s:'09:00',e:'17:00'}],
  6:[
    // Rayen : tous les samedis
    {empId:6,s:'10:00',e:'19:00'},
    // Inès : tous les samedis
    {empId:5,s:'09:00',e:'19:00'},
    // Groupe A (paires) : Clara + Aurélie
    {empId:7,s:'09:00',e:'19:00',altSam:true,samGrp:'A'},
    {empId:4,s:'09:00',e:'19:00',altSam:true,samGrp:'A'},
    // Groupe B (impaires) : Sirine
    {empId:8,s:'09:00',e:'19:00',altSam:true,samGrp:'B'},
    // Ahlam (9) et Imran (1) : pas de samedi
  ],
};
