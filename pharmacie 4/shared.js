...
// ALTERNANCE SEMAINES :
// Groupe A (paires, actif cette semaine sem 13) : Imran(1), Clara(7), Aurélie(4)
// Groupe B (impaires, actif sem pro sem 14)     : Inès(5), Sirine(8)
// Tous les jours                                : Rayen(6), Imene(3), Ahlam(9)
// samSem=0 → semaines paires = groupe A actif
const SCHED={
  1:[
    {empId:1,s:'08:30',e:'19:30',altWk:true,wkGrp:'A'},  // Imran : sem A
    {empId:3,s:'08:30',e:'19:30'},                         // Imene : tous
    {empId:6,s:'10:00',e:'19:30'},                         // Rayen : tous
    {empId:9,s:'09:00',e:'17:00'},                         // Ahlam : tous
  ],
  2:[
    {empId:1,s:'08:30',e:'19:30',altWk:true,wkGrp:'A'},
    {empId:3,s:'08:30',e:'19:30'},
    {empId:6,s:'10:00',e:'19:30'},
    {empId:9,s:'09:00',e:'17:00'},
  ],
  3:[
    {empId:3,s:'08:30',e:'19:30'},
    {empId:5,s:'08:30',e:'19:30',altWk:true,wkGrp:'B'},  // Inès : sem B
    {empId:6,s:'10:00',e:'19:30'},
    {empId:7,s:'08:30',e:'19:30'},
    {empId:8,s:'08:30',e:'19:30'},
  ],
  4:[
    {empId:5,s:'08:30',e:'19:30',altWk:true,wkGrp:'B'},
    {empId:6,s:'10:00',e:'19:30'},
    {empId:7,s:'08:30',e:'19:30'},
    {empId:8,s:'08:30',e:'19:30'},
    {empId:9,s:'09:00',e:'17:00'},
  ...
  6:[
    ...
    // Groupe A (paires) : Imran + Clara + Aurélie
    {empId:1,s:'09:00',e:'19:00',altSam:true,samGrp:'A'},
    {empId:7,s:'09:00',e:'19:00',altSam:true,samGrp:'A'},
    {empId:4,s:'09:00',e:'19:00',altSam:true,samGrp:'A'},
    // Groupe B (impaires) : Inès + Sirine
    {empId:5,s:'09:00',e:'19:00',altSam:true,samGrp:'B'},
...
function empShifts(date,empId){
  ...
  // Jours Lun-Ven : vérifier alternance semaine (altWk)
  const s=( SCHED[dow]||[]).find(x=>x.empId===empId);
  if(!s)return null;
  if(s.altWk){
    const grpAActive=isGrpAActive(date);
    if(s.wkGrp==='A'&&!grpAActive)return null;
    if(s.wkGrp==='B'&&grpAActive)return null;
  }
  return s;
}
